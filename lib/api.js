...
(function() {
  ...
  Api = (function() {
    ...
    Api.prototype.get = function(url, headers, cb) {
      ...
      return this.makeReqeust('get', url, null, headers, function(error, response) {
    ...
    Api.prototype.put = function(url, body, headers, cb) {
      ...
      return this.makeReqeust('put', url, body, headers, function(error, response) {
        return cb(error, response);
      });
    };
    ...
    Api.prototype.makeReqeust = function(verb, url, bodyOrReadableStream, headers, cb) {
